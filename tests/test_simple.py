...
def main():
    ...
    with open('network_safe_occndbtier_25.1.200.yaml', 'r') as f:
    ...
    enhanced_config = engine.preserve_network_config(golden_old, template_new, merged_result)
    ...
    for path in check_paths:
        ...
        if result_annotations and isinstance(result_annotations, list):
            enhanced_dict = engine._convert_array_annotations_to_dict(result_annotations)
